...
export function RSVPTemplateEditor({ template, settings, onSettingsChange, onClose }: RSVPTemplateEditorProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-casarei-primary-deep/30 backdrop-blur-sm" role="dialog" aria-modal="true">
      ...
      <div className="absolute bottom-0 left-1/2 max-h-[92vh] w-full max-w-5xl -translate-x-1/2 overflow-y-auto rounded-t-[2rem] bg-[#fffdf9] p-5 shadow-2xl md:top-1/2 md:max-h-[88vh] md:-translate-y-1/2 md:rounded-[2rem] md:p-7">
